...
export const cartSlice = createSlice({
    ...
    reducers: {
        ...
        removeItemFromCart: (state, action) => {
            ...
            const selectCartIndex = state.cartItems.findIndex(item => item.id === removedItem.id);
...
export const selectCartTotalPrice = state => state.cart.cartItems.reduce((total, item) => total+item.price, 0)